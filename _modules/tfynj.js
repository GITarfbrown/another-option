...
function get_each_context(ctx, list, i) {
	...
	child_ctx[34] = list[i].icon;
	return child_ctx;
}

// (15:8) {#each social_links as {link, icon}}
function create_each_block(ctx) {
	...
	let t_1;
	let current;
	icon = new Component$1({ props: { icon: /*icon*/ ctx[34] } });
	...
	return {
		...
		h() {
			...
			attr(a, "aria-label", a_aria_label_value = /*icon*/ ctx[34]);
			attr(a, "class", "svelte-1t5t67p");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			const icon_changes = {};
			if (dirty[0] & /*social_links*/ 1) icon_changes.icon = /*icon*/ ctx[34];
			icon.$set(icon_changes);

			if (!current || dirty[0] & /*social_links*/ 1 && a_href_value !== (a_href_value = /*link*/ ctx[33].url)) {
				attr(a, "href", a_href_value);
			}

			if (!current || dirty[0] & /*social_links*/ 1 && a_aria_label_value !== (a_aria_label_value = /*icon*/ ctx[34])) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(span0, "class", "svelte-1t5t67p");
			attr(a0, "class", "email svelte-1t5t67p");
			attr(a0, "href", a0_href_value = "mailto:" + /*email*/ ctx[2]);
			attr(div0, "class", "primary svelte-1t5t67p");
			attr(span1, "class", "copyright svelte-1t5t67p");
			attr(a1, "href", "https://primo.so");
			attr(a1, "class", "svelte-1t5t67p");
			attr(span2, "class", "primo svelte-1t5t67p");
			attr(ul, "class", "svelte-1t5t67p");
			attr(div1, "class", "secondary svelte-1t5t67p");
			attr(div2, "class", "section-container svelte-1t5t67p");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('wcijq' in $$props) $$invalidate(31, wcijq = $$props.wcijq);
		if ('dzstp' in $$props) $$invalidate(32, dzstp = $$props.dzstp);
